...
{
    public class TDP_Boost_Slider : CommonUserControl_SliderToggleSwitch
    {
        public TDP_Boost_Slider()
        {
            ...
            slider.Value = TDP_Management.Instance.ReadAndReturnBoostTDP();
            ...
            mainText = Application.Current.Resources["Usercontrol_Boost_TDP_Maintext"].ToString();
            subText = Application.Current.Resources["Usercontrol_Boost_TDP_Subtext"].ToString();
            valueText = Application.Current.Resources["Usercontrol_Boost_TDP_Unitvalue"].ToString();
        }
