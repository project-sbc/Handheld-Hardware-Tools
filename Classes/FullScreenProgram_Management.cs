...
{
    public static class FullScreenProgram_Management
    {
        ...
        public static void checkSuspendProcess()
        {
            ...
            foreach (Process process in pList)
            {
                if (process.MainWindowHandle != IntPtr.Zero)
                {
                    ...
                    else if (FullScreenProgram_Management.IsForegroundFullScreen(new HandleRef(null, process.MainWindowHandle), null) && !FullScreenProgram_Management.ExcludeFullScreenProcessList.Contains(process.ProcessName))
                    {
