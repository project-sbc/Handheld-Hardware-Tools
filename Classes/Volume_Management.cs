...
namespace Everything_Handhelds_Tool.Classes
{
    ...
    {
        private static Volume_Management _instance = null;
        private static readonly object lockObj = new object();
        private Volume_Management()
        {
        }
        public static Volume_Management Instance
        {
            get
            {
                if (_instance == null)
                {
                    lock (lockObj)
                    {
                        if (_instance == null)
                        {
                            _instance = new Volume_Management();
                        }
                    }
                }
                return _instance;
        ...
        public void GetMasterVolumeMute()
        {
            IAudioEndpointVolume masterVol = null;
            try
            {
